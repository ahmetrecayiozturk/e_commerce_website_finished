      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Paketiniz 3-5 iş günü içinde teslimat noktanıza veya adresinize
              ulaştırılır.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Ürün beklentinize uymadı mı? Sorun değil; ürününüzü yenisiyle
              değiştirebiliriz.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Ürününüzü iade edin, ücretinizi geri ödeyelim. İade sürecinizi
              kolaylaştırmak için elimizden geleni yaparız.
            </p>
          </div>
        </div>
      </div>
